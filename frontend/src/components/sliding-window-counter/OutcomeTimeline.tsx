...
type TooltipPoint = {
  ...
  currentWindowCount: number | null;
  previousWindowCount: number | null;
  previousWindowWeight: number | null;
...
export function OutcomeTimeline({ events }: OutcomeTimelineProps) {
  ...
  const chartData = useMemo(() => {
    ...
    decisionEvents.forEach((event) => {
      ...
      const point: TooltipPoint = {
        ...
        estimatedCount: decision.algorithmState?.estimatedCount ?? null,
        currentWindowCount: decision.algorithmState?.currentWindowCount ?? null,
        previousWindowCount: decision.algorithmState?.previousWindowCount ?? null,
        previousWindowWeight: decision.algorithmState?.previousWindowWeight ?? null,
  ...
  return (
    <section className="card panel">
      ...
      <p className="meta">Outcome points align with estimated_count threshold crossing behavior in SWC.</p>
      <div className="chart-surface" ref={containerRef} aria-label="SWC outcome timeline chart" />
    </section>
  );
}
